...
![](/static/img/fe-liu-7.png)

### 步骤五 — 布局（Layout）
----
布局阶段需要确定页面上所有元素的大小和位置。
![](/static/img/fe-liu-8.png)

### 步骤六 — 渲染（Paint）
----
最终的渲染阶段，会真正地光栅化屏幕上的像素，把页面呈现给用户。
![](/static/img/fe-liu-9.png)
